 ...
 */
public class WriteFragment extends Fragment implements TextToSpeech.OnInitListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myFragmentView = inflater.inflate(R.layout.fragment_write, container, false);

                btnSpeak=(CircleImageView) myFragmentView.findViewById(R.id.speak_image);

        txtText =(EditText) myFragmentView.findViewById(R.id.input_text);
